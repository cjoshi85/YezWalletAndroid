...
const CREATE_NEW_WALLET = 'WALLET/CREATE_NEW'
const CREATE_NEW_WALLET_START = 'WALLET/CREATE_NEW_START'
const CREATE_NEW_WALLET_SUCCESS = 'WALLET/CREATE_NEW_SUCCESS'
const CREATE_NEW_WALLET_ERROR = 'WALLET/CREATE_NEW_ERROR'
const RESET_STATE = 'WALLET/RESET_STATE'
const LOGIN = 'WALLET/LOGIN'
const LOGOUT = 'WALLET/LOGOUT'
const UPDATE_STATE='WALLET/UPDATE_STATE'
const UPDATE_STATE_START='WALLET/UPDATE_STATE_START'
const UPDATE_STATE_SUCCESS='WALLET/UPDATE_STATE_SUCCESS'
const TOGGLE_USER = 'WALLET/TOGGLE_USER'
const TOGGLE_USER_START='WALLER/TOGGLE_USER_START'
...
const SEND_ASSET_START = 'WALLET/SEND_ASSET_START'
...
export function createNew(passphrase, wif) {
    return {
